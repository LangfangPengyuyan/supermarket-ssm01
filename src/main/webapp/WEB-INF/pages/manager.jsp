...
<script type="text/javascript">
    ...
    function to_manage_commodities() {
        $("#commodity_frm").attr('action', '/supermarket/login');
...
<form id="manager_fm" action="/managerService/addMember" method="post">
    <div id="add_member" align="center">
        ...
        <br>
        <br>
        <input type="submit" id="add_btn" value="添加" onclick=""/>
        <input type="button" id="cancel_btn" value="取消" onclick="to_manage_commodities()"/>
        <br>
        <hr>
    </div>
