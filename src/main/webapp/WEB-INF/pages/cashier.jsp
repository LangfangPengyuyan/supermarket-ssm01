...
<%@ page import="com.supermarket.util.IDUtil" %>
<html>
<head>
...
<script type="text/javascript">
    ...
    function addCommodity() {
        ...
        $("#cashier_fm").attr('action', '/Cashier/addBoughtCommodity');
        $("#cashier_fm").submit();
    };
    ...
    function removeCommodity() {
        ...
        $("#cashier_fm").attr('action', '/Cashier/removeCommodity');
        $("#cashier_fm").submit();
    };
    ...
    function checkoutByCash() {
        ...
        $("#cashier_fm").attr('action', '/Cashier/checkoutByCash');
        $("#cashier_fm").submit();
    };
    ...
    function checkoutByMember() {
        ...
        $("#cashier_fm").attr('action', '/Cashier/checkoutByMember');
        $("#cashier_fm").submit();
    };
...
<form action="" id="cashier_fm" method="post">
    ...
    <div>
        ...
        <input type="submit" id="add_btn" value="查询商品" onclick="addCommodity()">
